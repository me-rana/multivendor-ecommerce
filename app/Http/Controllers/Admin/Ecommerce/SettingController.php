...
class SettingController extends Controller
{
    ...
    public function productSetting(){
        $productsetup = ProductSetup::first();
        return view('admin.e-commerce.product.product-setting',compact('productsetup'));
    }
    ...
    public function productSettingUpdate(Request $request){
        ...
        $productsetup = ProductSetup::first();
        $productsetup->update([
            'home_lg' => $request->home_lg,
            'home_md' => $request->home_md,
            'home_sm' => $request->home_sm,
            'home_extra_sm' => $request->home_extra_sm,
            'others_lg' => $request->others_lg,
            'others_md' => $request->others_md,
            'others_sm' => $request->others_sm,
            'others_extra_sm' => $request->others_extra_sm,
        ]);
        notify()->success("Product Setting updated Successfully", "Success");
    ...
    public function setting_g(Request $request)
    {
        ...
        Setting::updateOrCreate(['name' => 'paypal'], ['value' => json_encode($request->filled('paypal'))]);
        Setting::updateOrCreate(['name' => 'afterpay'], ['value' => json_encode($request->filled('afterpay'))]);
        Setting::updateOrCreate(['name' => 'zippay'], ['value' => json_encode($request->filled('zippay'))]);
