...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('additional_images')) {
            foreach ($request->file('additional_images') as $image) {
                ...
                $image->move(public_path('uploads/category'), $name_gen);
                $imagePath = $name_gen;
    ...
    public function edit(Category $category)
    {
        ...
        return view('admin.e-commerce.category.form', compact('category','categoryImages'));
    }
    ...
    public function destroy(Category $category)
    {
     ...
     public function categoryExitstingImage($id){
        $cat_image =  CategoryImage::where('id',$id)->first();
         File::delete($cat_image->image);
         $cat_image->delete();
         return back();
