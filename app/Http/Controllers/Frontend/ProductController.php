...
class ProductController extends Controller
{
    ...
    public function bulkBuy(Request $request)
    {
        ...
        return view('frontend.bulk-buy', compact('products')); 
    }
    ...
    {
        $key = request()->query('invite_key');
        $affiliate = AffiliateAccount::where('affiliate_key',$key)->first();
        if($affiliate != null){
            Session::forget('affiliate_key');
            Session::put('affiliate_key', $key);
