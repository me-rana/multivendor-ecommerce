...
{   
    ...
    public function store(Request $request){
        ...
        if ($request->hasFile('additional_images')) {
            foreach ($request->file('additional_images') as $image) {
                ...
                $image->move(public_path('uploads/campaign'), $name_gen);
                $imagePath = $name_gen;
    ...
    public function edit($id){
        ...
        $campaignImages = CampaignImage::where('campaign_id', $id)->get();
        
        return view('admin.e-commerce.campaign.create',compact('products','campaing','campaignImages'));
    }
    ...
    public function campaignExitstingImage($id){
        $cam_image =  CampaignImage::where('id',$id)->first();
         File::delete($cam_image->image);
         $cam_image->delete();
         return back();
    ...
    public function campaignProduct($id,Request $request){
        ...
        return view('frontend.cam_product', compact('products','id','campaigns_product','slug','campaign')); 
    }
