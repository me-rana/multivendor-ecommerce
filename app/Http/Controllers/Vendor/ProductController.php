...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            ...
            'image'             => 'required|image|mimes:jpg,jpeg,png,bmp,jfif,webp',
            'shipping_charge'   => 'nullable|boolean',
            'images'            => 'nullable|array',
            'images.*'          => 'nullable|image|mimes:jpg,jpeg,png,bmp,jfif,webp',
            'file_name'         => 'nullable',
    ...
    if($request->discount_price>0){
        ...
        $product = Product::create([
            ...
            'is_bulkbuy'             => $request->filled('is_bulkbuy'),
            'status'=>'0',
            'is_aproved'=>'0',
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->validate($request, [
            ...
            'colors'            => 'array',
            'colors.*'          => 'integer',
            'image'             => 'nullable|image|mimes:jpg,jpeg,png,bmp,jfif,webp',
            'shipping_charge'   => 'nullable|boolean',
            'file_name'         => 'nullable',
            'file_name.*'       => 'nullable|string|max:255',
            'file_url'          => 'nullable',
