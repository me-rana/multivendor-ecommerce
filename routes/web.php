...
use App\Http\Controllers\Frontend\AfterpayController;
...
//Paypal Payment
Route::get('paypal/payment', [PaymentController::class,'createPayment'])->name('paypal.pay');
Route::get('paypal/payment/execute', [PaymentController::class,'executePayment'])->name('paypal.execute');
//AfterPay Payment
Route::post('/payment/create', [AfterpayController::class, 'createPayment']);
Route::get('/payment/return', [AfterpayController::class, 'paymentReturn'])->name('payment.return');
Route::get('/payment/cancel', [AfterpayController::class, 'paymentCancel'])->name('payment.cancel');
...
Route::get('affiliate-register', [AccountController::class, 'registerAffiliate'])->name('registerAffiliate');
Route::Post('affiliate-registered', [AccountController::class, 'registeredAffiliate'])->name('registeredAffiliate');
Route::get('affiliate/login', [LoginController::class, 'affiliateLogin'])->name('affiliate.login');
Route::post('affiliate/login-submit', [LoginController::class, 'affiliateLoginSubmit'])->name('affiliate.login.submit');
Route::get('affiliate/dashboard', [AffiliateController::class,'dashboard'])->name('affiliate.dashboard');
Route::get('affiliate/affiliate-list', [AffiliateController::class,'affiliateList'])->name('affiliate.list');
Route::get('affiliate/affiliate-pending', [AffiliateController::class,'affiliatePending'])->name('affiliate.pending');
Route::get('affiliate/affiliate-approved', [AffiliateController::class,'affiliateApproved'])->name('affiliate.approved');
Route::group(['as' => 'affiliate.profile.', 'prefix' => 'affiliate/profile'], function () {
    Route::get('/', [AffiliateController::class, 'showUpdateProfileForm'])->name('update');
    Route::put('info', [AffiliateController::class, 'updateInfo'])->name('update.info');
    Route::get('change-password', [AffiliateController::class, 'showChangePasswordForm'])->name('change.password');
    Route::put('password/update', [AffiliateController::class, 'updatePassword'])->name('password.update');
});
Route::get('affiliate/withdraw',[AffiliateController::class,'affiliateWithdraw'])->name('affiliate.withdraw');
Route::post('affiliate/withdraw-submit',[AffiliateController::class,'affiliateWithdrawSubmit'])->name('affiliate.withdraw.submit');
Route::get('affiliate/withdraw-list',[AffiliateController::class,'affiliateWithdrawList'])->name('affiliate.withdraw.list');
Route::get('invite/{key}',[HomeController::class,'affiliateSession'])->name('affiliate.session');
//Import and Exporter Management
Route::get('import-exporter-register', [AccountController::class, 'registerImportExport'])->name('registerImportExport');
Route::Post('import-exporter-registered', [AccountController::class, 'registeredImportExport'])->name('registeredImportExport');
Route::get('import-exporter/login', [LoginController::class, 'ImportExportLogin'])->name('ImportExport.login');
Route::post('import-exporter/login-submit', [LoginController::class, 'ImportExportLoginSubmit'])->name('ImportExport.login.submit');
Route::get('import-exporter/dashboard', [ImportExportController::class,'dashboard'])->name('ImportExport.dashboard');
Route::get('import-exporter/list', [ImportExportController::class,'importexportList'])->name('ImportExport.list');
Route::get('import-exporter/create', [ImportExportController::class,'importexportCreate'])->name('ImportExport.create');
Route::post('import-exporter/store', [ImportExportController::class,'importexportStore'])->name('ImportExport.store');
Route::group(['as' => 'import-exporter.profile.', 'prefix' => 'import-exporter/profile'], function () {
    Route::get('/', [ImportExportController::class, 'showUpdateProfileForm'])->name('update');
    Route::put('info', [ImportExportController::class, 'updateInfo'])->name('update.info');
    Route::get('change-password', [ImportExportController::class, 'showChangePasswordForm'])->name('change.password');
    Route::put('password/update', [ImportExportController::class, 'updatePassword'])->name('password.update');
});
...
Route::get('shop/bulk-buy', [ProductController::class, 'bulkBuy'])->name('product.bulkbuy');
