...
use App\Http\Controllers\Admin\Ecommerce\AffiliateController;
...
use App\Http\Controllers\Admin\Ecommerce\ImportExportController;
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('/category/category-exitsting-image/{id}',[CategoryController::class, 'categoryExitstingImage'])->name('category.exiting.remove');
    ...
    Route::get('vender/expiry-soon',[VendorController::class,'expirysoon'])->name('vender.expiry_soon');
    ...
    Route::get('affiliate/change-pass/{id}', [AffiliateController::class, 'change_passIndex'])->name('affiliate.change_pass_index');
    Route::put('affiliate/change-pass/{id}', [AffiliateController::class, 'change_pass'])->name('affiliate.change_pass');
    Route::get('affiliate/withdraw/list', [AffiliateController::class, 'allwithlist'])->name('affiliate.withdraw');
    Route::get('affiliate/withdraw/{id}', [AffiliateController::class, 'aprove'])->name('affiliate.withdraw.aprove');
    Route::get('affiliate/withdrawc/{id}', [AffiliateController::class, 'cancel'])->name('affiliate.withdraw.cancel');
    Route::get('affiliate/withdrawd/{id}', [AffiliateController::class, 'delete'])->name('affiliate.withdraw.delete');
    
    
    
    Route::resource('import-exporter', ImportExportController::class);
    Route::get('import-exporter/change-pass/{id}', [ImportExportController::class, 'change_passIndex'])->name('importExporter.change_pass_index');
    Route::put('import-exporter/change-pass/{id}', [ImportExportController::class, 'change_pass'])->name('importExporter.change_pass');
    Route::get('import-exporter/request-lists/{id}', [ImportExportController::class, 'ImportExportList'])->name('importExporter.ImportExportList');
    Route::get('import-exporter/request-list/edit/{id}/{sid}', [ImportExportController::class, 'ImportExportListEdit'])->name('importExporter.ImportExportListEdit');
    Route::post('import-exporter/update-item', [ImportExportController::class, 'ImportExportItemUpdate'])->name('importExporter.ImportExportItemUpdate');
    ...
    Route::get('/campaing/campaign-exitsting-image/{id}',[campaingController::class, 'campaignExitstingImage'])->name('campaign.exiting.remove');
    ...
    Route::get('setting/product-setting', [SettingController::class, 'productSetting'])->name('setting.product');
    Route::post('setting/product-setting', [SettingController::class, 'productSettingUpdate'])->name('setting.product.update');
});
