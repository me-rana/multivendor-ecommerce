        ...
        <div class="col-md-6 offset-md-3">
            <div class="card">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{route('affiliate.withdraw.list')}}" class="btn btn-primary">History</a>
                </div>
                </div>
                ...
                <form action="{{ route('affiliate.withdraw.submit') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="number" name="amount" id="amount" placeholder=" amount" class="form-control @error('amount') is-invalid @enderror" required>
                            @error('amount')
