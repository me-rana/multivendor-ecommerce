...
<div class="wrapper">
  <!--   <p style="text-align: center;">
    ...
    <form class="col-md-6 offset-md-3" action="{{route('affiliate.login.submit')}}" method="post" enctype="multipart/form-data">
        @csrf
         <ul class="cc row">
        <li class="col-6"  style="background:#32014e;color: white;"><a>Affiliate Login</a></li>
        <li class="col-6"><a href="{{route('registerAffiliate')}}">Affiliate Register</a></li>
    </ul>
    ...
    <br>
    <span style="display: block;text-align: center;">Are you new here? <a href="{{route('registerAffiliate')}}">Register Now (Affiliate)</a></span>
</div>
