            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" name="is_bulkbuy" id="is_bulkbuy" @isset($product){{ $product->is_bulkbuy ? 'checked':''}} @endisset>
                ...
                <div class="form-group">
                    <div class="custom-control custom-switch">
                        ...
                        <label class="custom-control-label" for="download_able">Downloadable</label>
                    </div>
                    @error('download_able')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
