    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                ...
                <span class="text-white">Affiliate Panel</span>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{Request::is('affiliate.list') ? 'menu-is-opening menu-open':''}}">
                ...
                <li class="nav-item {{Request::is('affiliate-list') ? 'menu-is-opening menu-open':''}}">
                    <a href="{{routeHelper('affiliate-list')}}" class="nav-link">
                      <i class="nav-icon fas fa-tachometer-alt"></i>
                      <p>Affiliate (All)</p>
                    </a>
                </li>
                <li class="nav-item {{Request::is('affiliate-pending') ? 'menu-is-opening menu-open':''}}">
                    <a href="{{routeHelper('affiliate-pending')}}" class="nav-link">
                      <i class="nav-icon fas fa-tachometer-alt"></i>
                      <p>Affiliate (Pending)</p>
                    </a>
                </li>
                <li class="nav-item {{Request::is('affiliate-approved') ? 'menu-is-opening menu-open':''}}">
                    <a href="{{routeHelper('affiliate-approved')}}" class="nav-link">
                      <i class="nav-icon fas fa-tachometer-alt"></i>
                      <p>Affiliate (Approved)</p>
                    </a>
                </li>
                {{-- <li class="nav-item  ">
                ...
                <li class="nav-item">
                    <a href="{{route('affiliate.withdraw')}}" class="nav-link {{Request::is('withdraw*') ? 'active':''}}">
