                            ...
                            <table id="image-table" class="table table-bordered">
                                ...
                                <tbody id="image-table-body">
                                    ...
                                    @isset($campaing)
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('uploads/campaign/'.$image->image) }}" alt="Image" style="width: 200px; height: 100px;">
                                                <input type="hidden" name="existing_images[]" value="{{ $image->id }}">
                                            </td>
                                            <td>
                                                <a href="{{ url('admin/campaing/campaign-exitsting-image/'.$image->id) }}"><button type="button" class="btn btn-danger" data-id="{{ $image->id }}">Remove</button></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                        @endif
