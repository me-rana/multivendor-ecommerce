            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="business_no" id="business_no" placeholder="Business No" class="form-control @error('business_no') is-invalid @enderror" value="{{ $vendor->shop_info->business_no ?? old('business_no') }}" >
                        @error('business_no')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" name="expiry_date" id="expiry_date" placeholder="" class="form-control @error('expiry_date') is-invalid @enderror" value="{{ $vendor->shop_info->expiry_date ?? old('expiry_date') }}" >
                        @error('expiry_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="paypal" id="paypal" placeholder="Paypal" class="form-control @error('paypal') is-invalid @enderror" value="{{ $vendor->shop_info->paypal ?? old('paypal') }}" >
                        @error('paypal')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
