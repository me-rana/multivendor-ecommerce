                ...
                <div class="col-12">
                    <form action="{{route('admin.setting_g')}}" method="POST">
                        ...
                        <div class="card-body getway form-row">
                            ...
                            <div class="form-group col-md-6 col-12">
                                <label><input type="checkbox" name="paypal" @if(setting('paypal')=='true' )
                                        checked @endif> Paypal</label>
                                <p>Paypal is a online payment platform. Every one can pay via Paypal </p>
                            </div>

                            <div class="form-group col-md-6 col-12">
                                <label><input type="checkbox" name="afterpay" @if(setting('afterpay')=='true' )
                                        checked @endif> AfterPay</label>
                                <p>AfterPay is a online payment platform. Every one can pay via AfterPay </p>
                            </div>

                            <div class="form-group col-md-6 col-12">
                                <label><input type="checkbox" name="zippay" @if(setting('zippay')=='true' )
                                        checked @endif> ZipPay</label>
                                <p>ZipPay is a online payment platform. Every one can pay via ZipPay </p>
                            </div>
