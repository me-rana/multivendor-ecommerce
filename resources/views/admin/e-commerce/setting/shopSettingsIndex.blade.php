                                ...
                                {{-- <div class="form-group col-md-12"> --}}
                                    <ul class="form-row">
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="GUEST_CHECKOUT" class="text-capitalize">Guest Checkout</label>
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            ...
                                            <select class="form-control" name="CHECKOUT_TYPE" id="CHECKOUT_TYPE" disabled>
                                    ...
                                    <ul class="form-row">
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            ...
                                            <input class="form-control" type="text" name="COUNTRY_SERVE" id="COUNTRY_SERVE" placeholder="Bangladesh" value="{{ setting('COUNTRY_SERVE') ?? 'Australia' }}" required>
                                        </li>
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="shipping_range_inside" class="text-capitalize">Text - Shipping in Range <span class="text-red">*</span></label>
                                            <input class="form-control" name="shipping_range_inside" id="shipping_range_inside" class="border border-info p-1" type="text" value="{{ setting('shipping_range_inside') ?? "Sydney" }}" required>
                                        </li>
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="shipping_charge" class="text-capitalize">Charge(Amount) - Shipping in Range <span class="text-red">*</span></label>
                                            <input class="form-control" name="shipping_charge" id="shipping_charge" class="border border-info p-1" type="number" value="{{ setting('shipping_charge') ?? "5" }}" required>
                                        </li>
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="shipping_charge_out_of_range" class="text-capitalize">Charge(Amount) - Shipping in Out of Range <span class="text-red">*</span></label>
                                            <input class="form-control" name="shipping_charge_out_of_range" id="shipping_charge_out_of_range" class="border border-info p-1" type="number" value="{{ setting('shipping_charge_out_of_range') ?? "10" }}" required>
                                        </li>
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="shipping_free_above" class="text-capitalize">Free Shipping - Above Purchases Amount <span class="text-red">*</span></label>
                                            <input class="form-control" name="shipping_free_above" id="shipping_free_above" class="border border-info p-1" type="number" value="{{ setting('shipping_free_above') ?? "1000" }}" required>
                                        </li>
