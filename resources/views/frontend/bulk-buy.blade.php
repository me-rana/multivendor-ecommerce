    ...
    <div class="row">
        ...
        <div class="products col-md-9">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="load ajax-loading col-lg-{{ 12/$product_setup->others_lg }} col-md-{{ 12/$product_setup->others_md}} col-sm-{{ 12/$product_setup->others_extra_sm }} col-{{ 12/$product_setup->others_sm}}" style="display: none;">
