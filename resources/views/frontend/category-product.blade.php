        ...
        <div class="products col-md-9">
            ...
            <div class="container">
                <div class="row" style="margin-bottom: 10px;">
                    @php 
                        $category_sliders = App\Models\CategoryImage::where('category_id',$category->id)->get();
                    @endphp
                    @push('css')
                    ...
                    @if($category_sliders->count() > 0)
                    <div class="swiper mySwiper">
                        <div class="swiper-wrapper">

                        @foreach ($category_sliders as $key => $slider)
                        <div class="swiper-slide">
                            <img src="{{asset('uploads/category/'.$slider->image)}}" />
                        </div>
                        @endforeach
                    ...
                    @else
                        ...
                        @if($category->cover_image != null)
                            <img src="{{ asset('uploads/campaign/'.$category->cover_photo) }}" class="cam_responsive_image" />
                        @endif
                ...
                <div class="row " id="grid-view">
                    @forelse ($category->products as $product)
                        <x-product-grid-view :product="$product" classes="product px-3 col-lg-{{ 12/$product_setup->others_lg }} col-md-{{ 12/$product_setup->others_md }} col-sm-{{ 12/$product_setup->others_extra_sm }} col-{{ 12/$product_setup->others_sm }}"/>
                    @empty
